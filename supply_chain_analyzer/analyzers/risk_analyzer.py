...
from ..core.dependency_graph import DependencyGraph, SoftwareType, VulnerabilityLevel
...
class RiskAnalyzer:
    ...
    def export_metrics_to_csv(self, filepath: str = None, output_manager: OutputManager = None,
        ...
        if output_manager and project_name:
            saved_path = output_manager.save_risk_metrics(df, project_name)
            print(f"Metrics exported to {saved_path}")
            return saved_path
        elif filepath:
